...
UIKRigDefinition* FMixamoSkeletonRetargeter::CreateMixamoIKRig(const USkeleton* Skeleton) const
{
	...
	Controller->AddRetargetChain(FBoneChain(TEXT("Root"), TEXT("root"), TEXT("root"), NAME_None));
	Controller->AddRetargetChain(FBoneChain(TEXT("Spine"), TEXT("Spine"), TEXT("Spine2"), NAME_None));
	Controller->AddRetargetChain(FBoneChain(TEXT("Head"), TEXT("Neck"), TEXT("head"), NAME_None));
	static const FName LeftClavicleChainName(TEXT("LeftClavicle"));
	Controller->AddRetargetChain(FBoneChain(LeftClavicleChainName, TEXT("LeftShoulder"), TEXT("LeftShoulder"), NAME_None));
	static const FName LeftArmChainName(TEXT("LeftArm"));
	static const FName LeftHandBoneName(TEXT("LeftHand"));
	Controller->AddRetargetChain(FBoneChain(LeftArmChainName, TEXT("LeftArm"), LeftHandBoneName, NAME_None));
	static const FName RightClavicleChainName(TEXT("RightClavicle"));
	Controller->AddRetargetChain(FBoneChain(RightClavicleChainName, TEXT("RightShoulder"), TEXT("RightShoulder"), NAME_None));
	static const FName RightArmChainName(TEXT("RightArm"));
	static const FName RightHandBoneName(TEXT("RightHand"));
	Controller->AddRetargetChain(FBoneChain(RightArmChainName, TEXT("RightArm"), RightHandBoneName, NAME_None));
	static const FName LeftLegChainName(TEXT("LeftLeg"));
	static const FName LeftToeBaseBoneName(TEXT("LeftToeBase"));
	Controller->AddRetargetChain(FBoneChain(LeftLegChainName, TEXT("LeftUpLeg"), LeftToeBaseBoneName, NAME_None));
	static const FName RightLegChainName(TEXT("RightLeg"));
	static const FName RightToeBaseBoneName(TEXT("RightToeBase"));
	Controller->AddRetargetChain(FBoneChain(RightLegChainName, TEXT("RightUpLeg"), RightToeBaseBoneName, NAME_None));
	Controller->AddRetargetChain(FBoneChain(TEXT("LeftIndex"), TEXT("LeftHandIndex1"), TEXT("LeftHandIndex3"), NAME_None));
	Controller->AddRetargetChain(FBoneChain(TEXT("RightIndex"), TEXT("RightHandIndex1"), TEXT("RightHandIndex3"), NAME_None));
	Controller->AddRetargetChain(FBoneChain(TEXT("LeftMiddle"), TEXT("LeftHandMiddle1"), TEXT("LeftHandMiddle3"), NAME_None));
	Controller->AddRetargetChain(FBoneChain(TEXT("RightMiddle"), TEXT("RightHandMiddle1"), TEXT("RightHandMiddle3"), NAME_None));
	Controller->AddRetargetChain(FBoneChain(TEXT("LeftPinky"), TEXT("LeftHandPinky1"), TEXT("LeftHandPinky3"), NAME_None));
	Controller->AddRetargetChain(FBoneChain(TEXT("RightPinky"), TEXT("RightHandPinky1"), TEXT("RightHandPinky3"), NAME_None));
	Controller->AddRetargetChain(FBoneChain(TEXT("LeftRing"), TEXT("LeftHandRing1"), TEXT("LeftHandRing3"), NAME_None));
	Controller->AddRetargetChain(FBoneChain(TEXT("RightRing"), TEXT("RightHandRing1"), TEXT("RightHandRing3"), NAME_None));
	Controller->AddRetargetChain(FBoneChain(TEXT("LeftThumb"), TEXT("LeftHandThumb1"), TEXT("LeftHandThumb3"), NAME_None));
	Controller->AddRetargetChain(FBoneChain(TEXT("RightThumb"), TEXT("RightHandThumb1"), TEXT("RightHandThumb3"), NAME_None));
	...
	{
		Controller->AddRetargetChain(FBoneChain(/*ChainName=*/BoneName, /*StartBoneName=*/BoneName, /*EndBoneName=*/BoneName, NAME_None));
	}
...
) const
{
	...
	Controller->AddRetargetChain(FBoneChain(TEXT("Root"), TEXT("root"), TEXT("root"), NAME_None));
	Controller->AddRetargetChain(FBoneChain(TEXT("Spine"), TEXT("spine_01"), SelectBySkeletonType(SkeletonType, TEXT("spine_03"), TEXT("spine_05")), NAME_None));
	Controller->AddRetargetChain(FBoneChain(TEXT("Head"), TEXT("neck_01"), TEXT("head"), NAME_None));
	static const FName LeftClavicleChainName(TEXT("LeftClavicle"));
	Controller->AddRetargetChain(FBoneChain(LeftClavicleChainName, TEXT("clavicle_l"), TEXT("clavicle_l"), NAME_None));
	static const FName LeftArmChainName(TEXT("LeftArm"));
	static const FName LeftHandBoneName(TEXT("hand_l"));
	Controller->AddRetargetChain(FBoneChain(LeftArmChainName, TEXT("upperarm_l"), LeftHandBoneName, NAME_None));
	static const FName RightClavicleChainName(TEXT("RightClavicle"));
	Controller->AddRetargetChain(FBoneChain(RightClavicleChainName, TEXT("clavicle_r"), TEXT("clavicle_r"), NAME_None));
	static const FName RightArmChainName(TEXT("RightArm"));
	static const FName RightHandBoneName(TEXT("hand_r"));
	Controller->AddRetargetChain(FBoneChain(RightArmChainName, TEXT("upperarm_r"), RightHandBoneName, NAME_None));
	static const FName LeftLegChainName(TEXT("LeftLeg"));
	static const FName LeftBallBoneName(TEXT("ball_l"));
	Controller->AddRetargetChain(FBoneChain(TEXT("LeftLeg"), TEXT("thigh_l"), LeftBallBoneName, NAME_None));
	static const FName RightLegChainName(TEXT("RightLeg"));
	static const FName RightBallBoneName(TEXT("ball_r"));
	Controller->AddRetargetChain(FBoneChain(RightLegChainName, TEXT("thigh_r"), RightBallBoneName, NAME_None));
	Controller->AddRetargetChain(FBoneChain(TEXT("LeftIndex"), TEXT("index_01_l"), TEXT("index_03_l"), NAME_None));
	Controller->AddRetargetChain(FBoneChain(TEXT("RightIndex"), TEXT("index_01_r"), TEXT("index_03_r"), NAME_None));
	Controller->AddRetargetChain(FBoneChain(TEXT("LeftMiddle"), TEXT("middle_01_l"), TEXT("middle_03_l"), NAME_None));
	Controller->AddRetargetChain(FBoneChain(TEXT("RightMiddle"), TEXT("middle_01_r"), TEXT("middle_03_r"), NAME_None));
	Controller->AddRetargetChain(FBoneChain(TEXT("LeftPinky"), TEXT("pinky_01_l"), TEXT("pinky_03_l"), NAME_None));
	Controller->AddRetargetChain(FBoneChain(TEXT("RightPinky"), TEXT("pinky_01_r"), TEXT("pinky_03_r"), NAME_None));
	Controller->AddRetargetChain(FBoneChain(TEXT("LeftRing"), TEXT("ring_01_l"), TEXT("ring_03_l"), NAME_None));
	Controller->AddRetargetChain(FBoneChain(TEXT("RightRing"), TEXT("ring_01_r"), TEXT("ring_03_r"), NAME_None));
	Controller->AddRetargetChain(FBoneChain(TEXT("LeftThumb"), TEXT("thumb_01_l"), TEXT("thumb_03_l"), NAME_None));
	Controller->AddRetargetChain(FBoneChain(TEXT("RightThumb"), TEXT("thumb_01_r"), TEXT("thumb_03_r"), NAME_None));
	if (bIsUE5Skeleton)
	{
		...
		Controller->AddRetargetChain(FBoneChain(TEXT("LeftIndexMetacarpal"), TEXT("index_metacarpal_l"), TEXT("index_metacarpal_l"), NAME_None));
		Controller->AddRetargetChain(FBoneChain(TEXT("RightIndexMetacarpal"), TEXT("index_metacarpal_r"), TEXT("index_metacarpal_r"), NAME_None));
		Controller->AddRetargetChain(FBoneChain(TEXT("LeftMiddleMetacarpal"), TEXT("middle_metacarpal_l"), TEXT("middle_metacarpal_l"), NAME_None));
		Controller->AddRetargetChain(FBoneChain(TEXT("RightMiddleMetacarpal"), TEXT("middle_metacarpal_r"), TEXT("middle_metacarpal_r"), NAME_None));
		Controller->AddRetargetChain(FBoneChain(TEXT("LeftPinkyMetacarpal"), TEXT("pinky_metacarpal_l"), TEXT("pinky_metacarpal_l"), NAME_None));
		Controller->AddRetargetChain(FBoneChain(TEXT("RightPinkyMetacarpal"), TEXT("pinky_metacarpal_r"), TEXT("pinky_metacarpal_r"), NAME_None));
		Controller->AddRetargetChain(FBoneChain(TEXT("LeftRingMetacarpal"), TEXT("ring_metacarpal_l"), TEXT("ring_metacarpal_l"), NAME_None));
		Controller->AddRetargetChain(FBoneChain(TEXT("RightRingMetacarpal"), TEXT("ring_metacarpal_r"), TEXT("ring_metacarpal_r"), NAME_None));
	}
